...
(function(){
    ...
    var weightMapping = [
        ...
        ["CC13-01",96.85,"Food"],
        ["CC13-021",16.96,"Alcohol"],
        ["CC13-1111",31.77,"Restaurants & Cafés"],       
        ["CC13-0411",196.32,"Net rent"],
        ["CC13-0452",24.77,"Gas"],
        ["CC13-0453",11.54,"Heating oil"],
        ["CC13-0451",25.92,"Electricity"],
        ["CC13-072",70.7,"Fuels"],
        ["CC13-0711",31.56,"Car purchase"],
        ["CC13-073",23.69,"Public transport"],
        ["Freizeit",27.41,"Recreation & culture"],
        ["CC13-096",26.62,"Package holidays"],
        ["CC13-03",45.34,"Clothing"],
        ["CC13-083",22.22,"Communication"],
        ["Elektro",24.98,"Eletrical applicances"],
        ["CC13-121",22.88,"Personal care"],
        ["CC13-06",46.13,"Health"],
        ["CC13-022",20.81,"Tobacco"],
        ["REST",233.53,"Rest"]
    ...
    options = {
        ...
        caption: {
            text: 'Deviations due to rounding possible.',
            margin: 5
        },
        chart: {
            renderTo: 'container',
    ...
    // load the CSV data
    Highcharts.ajax({
        url: '/inflationsrechner/data/inflationsrechner.csv',
        dataType: 'text',
        success: function(csv) {
            ...
            showChange( changeP1, 'Official rate: ', calcChange(chart.series[0]) );
    ...
    function showMonth (element, arrayLength) {
        ...
        var date = new Date(timestamp).toLocaleDateString('en-EN', options);

        element[0].innerText = 'Status: ' + date;
